...
<body>
    <div class="container">
        <div class="imagen">
            <img src="https://learnidea.ideasoft.site/public/img/logo_dark.svg" alt="Learnidea" width="100" height="100" />
        </div>
        <h1>Bienvenido a Learnidea</h1>
        <p>Gracias por registrarse en Learnidea, una institución de educación mediante cursos presenciales y virtuales. Para continuar con su registro, por favor confirme su dirección de correo electrónico haciendo clic en el siguiente enlace:</p>
