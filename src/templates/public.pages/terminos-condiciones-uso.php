        ...
        <section>
            <div class="container">
                ...
                <ol>
                    ...
                    <li>
                        <h2>Uso indebido</h2>
                        <p>Consideramos un uso indebido de la plataforma la realización de cualquiera de las siguientes acciones:</p>
                        <ul>
                            <li>
                                <p>Usar software u otras herramientas para extraer activos o contenidos de nuestra plataforma.</p>
                            </li>
                            <li>
                                <p>Patrones de visualización que se correspondan con el uso de bots o programas de descarga y no con el uso humano, como completar los videos de las clases en pocos segundos y en secuencia o terminar cursos en pocos minutos.</p>
                            </li>
                            <li>
                                <p>Ver menos de 2 minutos de una clase y repetir ese comportamiento durante 30 o más clases en un mismo día.</p>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <p>Los presentes Términos y Condiciones se regirán e interpretarán de acuerdo con las leyes de [país donde está registrada la empresa], y cualquier controversia que surja de ellos o en relación con ellos se someterá a la jurisdicción exclusiva de los tribunales de Macas.</p>
                    </li>
                    <li>
                        <h2>Modificación de los términos y condiciones</h2>
                        <p>La empresa se reserva el derecho de modificar en cualquier momento los Términos y Condiciones de uso sin previo aviso. Las modificaciones serán efectivas desde el momento de su publicación en el sitio web. El uso continuado del sitio web y los servicios ofrecidos en él después de la publicación de los Términos y Condiciones modificados implicará la aceptación de los mismos.</p>
                    </li>
                    <li>
                        <h2>Acuerdo completo</h2>
                        <p>Estos Términos y Condiciones constituyen el acuerdo completo entre el usuario y la empresa en relación con el uso del sitio web y los servicios ofrecidos en él, y reemplazan cualquier acuerdo o entendimiento previo, ya sea escrito o verbal, en relación con el mismo.</p>
                    </li>
